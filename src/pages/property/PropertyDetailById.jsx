...
const PropertyDetailById = () => {
  ...
  return (
    <div className="w-full  p-[40px]">
      ...
      <h1 className='text-5xl text-center font-mono font-bold p-5 text-red-500'>Property Detail</h1>
      <div className="w-full m-10 rounded-md flex items-center justify-between">
        <div className="flex-2 w-[400px] h-[500px] shadow-md shadow-red-500 rounded-md">
        ...
        <div className="flex-3 items-center p-10 justify-center text-center">
          <div className="flex flex-col">
            ...
            <h2 className='text-5xl text-red-500 font-bold tracking-wide font-mono p-2 m-3'>Price: {selectedProperty.price}</h2>
            <a href="tel:'+923476985088'" className="bg-red-500 p-2 text-white m-3 rounded-md text-2xl">Call Now</a>
          </div>
        </div>
      </div>
    </div>
